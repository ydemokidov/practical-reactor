...
public class c7_ErrorHandling extends ErrorHandlingBase {
    ...
    public void resilience() {
        ...
        Flux<String> content = getFilesContent()
                .flatMap(stringMono -> stringMono.onErrorResume(throwable -> Mono.empty()))
                ; //start from here
    ...
    public void good_old_polling() {
        //todo: change code as you need
        Flux<String> alerts = nodeAlerts().repeatWhenEmpty(s-> s.delayElements(Duration.ofSeconds(1))).repeat();
